...
class ReportPlayerScreen extends StatefulWidget {
  ...
  const ReportPlayerScreen({Key? key, required this.playerId, required this.playerName}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('SIGNALER UN JOUEUR', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              Text('Signaler ${widget.playerName}', style: const TextStyle(fontSize: 15)),
