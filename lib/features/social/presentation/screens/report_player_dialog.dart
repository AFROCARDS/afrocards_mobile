              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.flag_rounded, color: _DesignColors.pink, size: 24),
                    ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Icon(Icons.person, size: 16, color: _DesignColors.secondary),
                      const SizedBox(width: 8),
                      Text(playerName, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: _DesignColors.secondary)),
                    ],
                  ),
                ),
                      ...
                      onPressed: submitting ? null : () async {
                        ...
                        try {
                          final response = await http.post(
                            Uri.parse(ApiEndpoints.buildUrl('/social/report')),
                            headers: {'Content-Type': 'application/json', 'Authorization': 'Bearer $token'},
                            body: jsonEncode({'idSignale': playerId, 'motif': reasons[selectedReason!], 'details': detailsController.text.trim()}),
                          );
